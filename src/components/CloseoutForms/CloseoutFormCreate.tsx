  ...
  React.useEffect(() => {
    if (editForm && open) {
      ...
      handleDataExtracted({
        ...
        tSlipType: editForm.tSlipType || '',
        otherDocuments: editForm.otherDocuments || '',
        personalTaxInstallmentsRequired: editForm.personalTaxInstallmentsRequired || false,
        hstInstallmentsRequired: editForm.hstInstallmentsRequired || false,
        outstandingTaxBalance: editForm.outstandingTaxBalance || '$0.00',
        ...
        taxPaymentDueDate: editForm.taxPaymentDueDate || editForm.dueDate,
        returnFilingDueDate: editForm.returnFilingDueDate || 'April 30',
        ...
        yearlyAmounts: editForm.yearlyAmounts || [],
